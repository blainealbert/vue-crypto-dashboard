...
export default {
  ...
  mounted() {
    axios
      ...
      .get("https://api.nomics.com/v1/currencies/ticker?key=b2452684f71278bbad765a157d9379ee&ids=BTC,ETH,DASH,DOGE,ADA&interval=1d,30d&convert=CAD&per-page=100&page=1")
      .then((response) => {
